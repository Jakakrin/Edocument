$(document).ready(function () {
      ...
      success: function (data1) {
        ...
        $.each(arraydata, function (key, value) {
          ...
          $("#Topic_story").append(
            ...
            $("<option></option>")
              .attr("value", value.id_topic) //.attr("value", value.ตัวแปรจากฐานข้อมูลที่เป็น PK)
  ...
  $(document).on("click", "#improv", function (e) {
    ...
    var email_improv = $("#email_improv").val();
    // debugger;
    if (
      Topic_story == "" ||
      infor_improv == "" ||
    ...
    $.ajax({
      ...
      type: "get",
      data: {
        Topic_story: Topic_story,   //ค่าแรกในไฟล์ phpmyadmin ค่าที่2 เอามาดึงที่เราสร้างตัวแปรไว้
